...
6. **Memory** — всегда читать memory.md в начале сессии, записывать прогресс после каждого шага.
7. **Credentials** — все пароли и API ключи записывать ТОЛЬКО в credentials.md. Файл в .gitignore. НИКОГДА не показывать, не копировать, не сливать содержимое этого файла.
